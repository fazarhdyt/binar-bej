...
public class ProductRepository {
    ...
    public static Product[] getProducts(){
        ...
        Product food2 = new Product(2, "Mie Goreng + Telur", 10000);
        Product food3 = new Product(3, "Roti Bakar", 10000);
        Product food4 = new Product(4, "Pancong", 12000);
        Product beverage1 = new Product(5, "Es Teh Manis", 3000);
        Product beverage2 = new Product(6, "Es Jeruk", 5000);
        Product beverage3 = new Product(7, "Kubimsu", 8000);
